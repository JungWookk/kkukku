import 'package:kkukku/src/screens/home/similar_item.dart';
import 'package:kkukku/src/states/category_controller.dart';
...
class _ItemDetailPageState extends State<ItemDetailPage> {
  ...
  void _goToChatroom(ItemModel2 itemModel, UserModel1 userModel) async {
    String chatroomKey = ChatroomModel2.generateChatRoomKey(
        buyer: userModel.userKey, itemKey: newItemKey);
    // logger.d({
