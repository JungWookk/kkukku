import 'package:kkukku/src/repo/item_service.dart';
import 'package:kkukku/src/states/user_controller.dart';
        ...
        return InkWell(
          ...
          onTap: () {
            ...
            Get.toNamed('/$ROUTE_ITEM_DETAIL',
                arguments: {'itemKey': _item.itemKey});
          },
          child: SizedBox(
            height: imgSize,
            child: Row(
  ...
  Widget _shimmerListView(double imgSize) {
    ...
    _containerSample(
      ...
      return Container(
          height: height,
          width: width,
          decoration: containerDeco(radius: radius));
    }
